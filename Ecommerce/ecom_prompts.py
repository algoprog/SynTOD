...
ACKNOWLEDGE_PROMPT = {
    ...
    Don't mention any specific product name do not ask any product related questions, or do not ask bot to do anything like add to cart or remove from cart.
    One in each line, no enumeration, use simple diverse human-like language, no quotes.
    Examples :  okay, that's a good product, hmm..., nice.
